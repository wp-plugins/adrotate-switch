...
function adrotateswitch_main() {
	...
	<div class="wrap">
		...
		<div id="dashboard-widgets-wrap">
					...
					<div class="meta-box-sortables">
						...
						<div class="postbox-adrotate">
							<div class="inside">
								...
								<p><strong>Notes:</strong> No location/placement data migrated. Zones are migrated to groups with default settings. AdCode generated on the fly based on your banners.</p>
							</div>
						</div>
						...
						<div class="postbox-adrotate">
							<div class="inside">
								<form method="post" action="admin.php?page=adrotate-switch">
									...
									<label for="adrotateswitch_import_adking_schedules">&nbsp;&nbsp;&nbsp;<input type="checkbox" name="adrotateswitch_import_adking_schedules" value="1" /> Import expiry dates into schedules</label><br />
								...
								<p><strong>Notes:</strong> HTML5 and Flash banners are not imported. Banner Zones are not compatible. AdCode will be generated on the fly based on your settings.</p>
							</div>
						</div>
					...
					<div class="meta-box-sortables">
						...
						<div class="postbox-adrotate">
							<div class="inside">
								...
								<p><strong>Notes:</strong> Slots not migrated. AdCode will be generated on the fly based on your banners.</p>
							</div>
						</div>
						...
						<div class="postbox-adrotate">
							<div class="inside">
								...
								<a href="https://www.adrotateplugin.com/contact/" target="_blank">Get in touch</a>!</p>
								<h4>Something wrong?</h4>
								<p>Module outdated or import not working? <a href="https://www.adrotateplugin.com/contact/" target="_blank">Let me know</a>!</p>
							</div>
						</div>
			...
			<div class="clear"></div>
			<center><small>AdRotate&trade; and the AdRotate Logo are owned by Arnan de Gans for AJdG Solutions.</small></center>
		</div>
